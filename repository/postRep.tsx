...
export const samplePostData : Post[] = [
  ...
  { id : 6, title:'내마음은 바다와!!', content :'여섯번째 글입니다'},
  { id : 7, title:'일곱난쟁이', content :'일곱번째 글입니다'},
  { id : 8, title:'하응하응!!', content :'아잉으응 글입니다'},
  { id : 9, title:'자바스크립트!!', content :'오늘은 일요일입니다'},
  { id : 10, title:'자바를 자바!!', content :'신나게 놀자입니다'},
